...
root = Tk()
root.title("Simple calculator") # title displayed at top

e = Entry(root, width=35, borderwidth=5)
e.grid(row=0, column=0, columnspan=3, padx=10, pady=10) # column span is number of columns item will occupy
...
divide_button = Button(root, text="/", padx=41, pady=20, command=button_divide)
